...
/* Define if compiling with the stsChClockDigital module files.  */
#define USING_STSCHCLOCKDIGITAL_MODULE 1
 
/* Define if compiling with the stsChClockDigitalShmLib module files.  */
#define USING_STSCHCLOCKDIGITALSHMLIB_MODULE 1
